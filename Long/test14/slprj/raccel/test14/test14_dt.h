...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . atirkgn1ea [ 0 ] ) , 0 , 0 ,
36 } , { ( char_T * ) ( & rtDW . nrx51v3ffl [ 0 ] ) , 0 , 0 , 8 } , { (
char_T * ) ( & rtDW . puakpty0gl ) , 11 , 0 , 24 } , { ( char_T * ) ( & rtDW
. o2ji33fn0m ) , 10 , 0 , 6 } , { ( char_T * ) ( & rtDW . ixolmoocom ) , 8 ,
0 , 2 } } ; static DataTypeTransitionTable rtBTransTable = { 5U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . Gain_Gain ) , 0 , 0 , 20 } } ; static
