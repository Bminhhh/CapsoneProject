...
MODEL                   = test14
MODULES                 = test14_9449aeaa_1.c test14_9449aeaa_1_create.c test14_9449aeaa_1_setParameters.c test14_9449aeaa_1_asserts.c test14_9449aeaa_1_deriv.c test14_9449aeaa_1_checkDynamics.c test14_9449aeaa_1_compOutputs.c test14_9449aeaa_1_asm_delegate.c test14_9449aeaa_1_sim_delegate.c test14_9449aeaa_1_mode_zero_crossings.c test14_9449aeaa_1_logging.c test14_9449aeaa_1_geometries.c test14_9449aeaa_1_gateway.c rt_backsubrr_dbl.c rt_forwardsubrr_dbl.c rt_lu_real.c rt_matrixlib_dbl.c rtGetInf.c rtGetNaN.c rt_nonfinite.c test14.c test14_capi.c test14_data.c test14_tgtconn.c rt_logging_mmi_simtarget.c rtw_modelmap_utils_simtarget.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = test14.exe
MAKEFILE                = test14.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2022b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2022b
START_DIR               = E:\Hoc\do an\(final) download\test14
S_FUNCTIONS_LIB         = 
NUMST                   = 3
NCSTATES                = 20
BUILDARGS               =  RSIM_SOLVER_SELECTION=2 PCMATLABROOT="C:\\Program Files\\MATLAB\\R2022b" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DTGTCONN -DIS_SIM_TARGET -DNRT -DRSIM_PARAMETER_LOADING -DRSIM_WITH_SL_SOLVER -DENABLE_SLEXEC_SSBRIDGE=1 -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DON_TARGET_WAIT_FOR_START=0 -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = test14_ref.rsp
COMPILER_COMMAND_FILE     = test14_comp.rsp
